...
return [
  ...
  */
  'definitions' => [
    ...
    'sms' => [
      'enabled' => ['type' => 'boolean', 'default' => false, 'public' => false],
      'provider' => ['type' => 'string', 'default' => 'log', 'public' => false],
      'twilio_sid' => ['type' => 'string', 'default' => null, 'public' => false],
      'twilio_token' => ['type' => 'encrypted', 'default' => null, 'public' => false],
      'twilio_from' => ['type' => 'string', 'default' => null, 'public' => false],
      'africastalking_username' => ['type' => 'string', 'default' => null, 'public' => false],
      'africastalking_api_key' => ['type' => 'encrypted', 'default' => null, 'public' => false],
      'africastalking_from' => ['type' => 'string', 'default' => null, 'public' => false],
    ],
    'whatsapp' => [
      'enabled' => ['type' => 'boolean', 'default' => false, 'public' => false],
      'provider' => ['type' => 'string', 'default' => 'log', 'public' => false],
      ...
      'twilio_token' => ['type' => 'encrypted', 'default' => null, 'public' => false],
      'twilio_from' => ['type' => 'string', 'default' => null, 'public' => false],
      'twilio_content_sid' => ['type' => 'string', 'default' => null, 'public' => false],
      'twilio_content_variables' => ['type' => 'string', 'default' => null, 'public' => false],
      'use_template' => ['type' => 'boolean', 'default' => false, 'public' => false],
    ],
  ],
];
