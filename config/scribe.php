...
return [
    ...
    'description' => 'Multi-tenant school ERP API. Authenticate with a Bearer Sanctum token from POST /api/v1/auth/login.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token via `POST /api/v1/auth/login`, then send `Authorization: Bearer {token}` on authenticated routes.',
    ],
