...
export const moduleEndpoints = {
  ...
  employees: e.employees.list,
  staffAttendance: e.staffAttendance.list,
  studentCategories: e.studentCategories.list,
  certificateTemplates: e.certificateTemplates.list,
  schoolCertificates: e.schoolCertificates.list,
  examSchedules: e.examSchedules.list,
  libraryMembers: e.libraryMembers.list,
  schoolCurrencies: e.schoolCurrencies.list,
  schoolLanguages: e.schoolLanguages.list,
  ...
  helpDeskTickets: e.helpDesk.list,
  recruitmentJobs: e.recruitment.jobs,
  recruitmentApplications: e.recruitment.applications,
