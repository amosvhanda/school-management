...
export const TEACHER_DASHBOARD_MODULE_GROUPS: DashboardModuleGroup[] = [
  {
    ...
    modules: [
      ...
      {
        title: 'Gradebook',
        description: 'Enter marks for your classes',
...
export const EXAM_OFFICER_DASHBOARD_MODULE_GROUPS: DashboardModuleGroup[] = [
  {
    ...
    modules: [
      ...
      {
        title: 'Academics analytics',
        description: 'Performance trends for examinations',
        href: '/academics/analytics',
        icon: 'BarChart3',
        capability: ['canManageExaminations', 'canEnterExamResults'],
      },
    ...
    modules: [
      {
        ...
        description: 'Exam notices and staff messages',
        href: '/communications',
        icon: 'Megaphone',
        capability: 'isStaff',
      },
...
export const PARENT_DASHBOARD_MODULE_GROUPS: DashboardModuleGroup[] = [
  {
    ...
    modules: [
      {
        title: 'My children',
        description: 'See progress, marks, attendance, and fees',
