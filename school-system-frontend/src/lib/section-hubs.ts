...
export const SECTION_HUBS: Record<SectionKey, SectionHubDefinition> = {
  people: {
    ...
    quickLinks: [
      ...
      { title: 'Guardians', description: 'Parents and contacts', href: '/people?tab=guardians', icon: 'UserCheck', capability: 'canManageStudents' },
      { title: 'Enrollment', description: 'Applications and intake', href: '/people?tab=enrollment', icon: 'ClipboardList', capability: 'canManageStudents' },
  ...
  hr: {
    ...
    quickLinks: [
      { title: 'Leave requests', description: 'Staff leave queue', href: '/hr?tab=leave', icon: 'Palmtree' },
      { title: 'Discipline', description: 'Student conduct records', href: '/hr?tab=discipline', icon: 'ShieldAlert' },
      { title: 'Policies', description: 'Compliance policies', href: '/hr?tab=policies', icon: 'Scale' },
      { title: 'Audit trail', description: 'Who did what across the system', href: '/hr?tab=audit', icon: 'ScrollText' },
