...
export const SECTION_HUBS: Record<SectionKey, SectionHubDefinition> = {
  ...
  finance: {
    ...
    quickLinks: [
      ...
      { title: 'Fee structures', description: 'Configure fees by class', href: '/finance?tab=fee-structures', icon: 'Tags' },
  ...
  operations: {
    ...
    capability: ['canManageInventory', 'canManageLibrary', 'canManageTransport', 'canManageReception', 'canManageHealth', 'canManageHostel'],
    quickLinks: [
      ...
      { title: 'Front office', description: 'Visitors and help desk', href: '/operations?tab=front-office', icon: 'ConciergeBell', capability: 'canManageReception' },
      ...
      { title: 'Hostels', description: 'Boarding houses and rooms', href: '/operations?tab=hostels', icon: 'Building2', capability: 'canManageHostel' },
      { title: 'Clinic visits', description: 'Student health records', href: '/operations?tab=health', icon: 'HeartPulse', capability: 'canManageHealth' },
