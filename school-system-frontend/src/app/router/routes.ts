...
export const staffRoutes: RouteRecordRaw[] = [
  ...
  staffListRoute('operations/inventory', 'ops-inventory', 'ops-inventory', 'canManageInventory'),
  ...
  staffListRoute('operations/inventory/sales', 'ops-inventory-sales', 'ops-inventory-sales', 'canManageInventory'),
  ...
  staffListRoute('operations/library', 'ops-library', 'ops-library', 'canManageLibrary'),
  staffListRoute('operations/transport', 'ops-transport', 'ops-transport', 'canManageTransport'),
  staffListRoute('operations/transport/drivers', 'ops-transport-drivers', 'ops-transport-drivers', 'canManageTransport'),
  staffListRoute('operations/transport/routes', 'ops-transport-routes', 'ops-transport-routes', 'canManageTransport'),
