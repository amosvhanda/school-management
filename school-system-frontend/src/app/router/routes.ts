...
export const staffRoutes: RouteRecordRaw[] = [
  ...
  staffHubRedirect('finance/fee-groups', 'finance-fee-groups', 'finance', 'fees', 'overview', 'canManageFinance'),
  staffHubRedirect('finance/fee-discounts', 'finance-fee-discounts', 'finance', 'fees', 'overview', 'canManageFinance'),
  ...
  staffHubRedirect('finance/accounting', 'finance-accounting', 'finance', 'accounting', 'overview', 'canManageFinance'),
