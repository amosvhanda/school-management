...
export const staffRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    path: 'dashboard/lms',
    name: 'dashboard-lms',
    component: () => import('@/modules/dashboard/views/panels/LmsDashboardPanel.vue'),
    meta: { capability: 'isStaff' },
  },
  {
    path: 'dashboard/:role(student|teacher|parent)',
    name: 'dashboard-role-preview',
    component: () => import('@/modules/dashboard/views/panels/AdminRolePreviewPanel.vue'),
  ...
  staffHubRedirect('finance/fees', 'finance-fees', 'finance', 'fee-structures', 'overview', 'canManageFinance'),
  staffHubRedirect('finance/fee-categories', 'finance-fee-categories', 'finance', 'fee-categories', 'overview', 'canManageFinance'),
  staffHubRedirect('finance/fee-groups', 'finance-fee-groups', 'finance', 'fee-groups', 'overview', 'canManageFinance'),
  staffHubRedirect('finance/fee-discounts', 'finance-fee-discounts', 'finance', 'fee-discounts', 'overview', 'canManageFinance'),
  ...
  staffHubRedirect('admin/subscription', 'admin-subscription', 'admin', 'subscription', 'users', 'canManageTeachers'),
  {
    path: 'operations',
    name: 'operations',
  ...
  staffHubRedirect('operations/inventory/sales', 'ops-inventory-sales', 'operations', 'inventory', 'inventory', 'canManageInventory', { section: 'ops-inventory-sales' }),
  staffHubRedirect('operations/procurement', 'ops-procurement', 'finance', 'procurement', 'overview', 'canManageFinance'),
  staffHubRedirect('operations/procurement/vendors', 'ops-procurement-vendors', 'finance', 'procurement', 'overview', 'canManageFinance', { section: 'ops-procurement-vendors' }),
  staffHubRedirect('operations/library', 'ops-library', 'operations', 'library-books', 'inventory', 'canManageLibrary'),
  staffHubRedirect('operations/library/books', 'ops-library-books', 'operations', 'library-books', 'inventory', 'canManageLibrary'),
  staffHubRedirect('operations/library/members', 'ops-library-members', 'operations', 'library-members', 'inventory', 'canManageLibrary'),
  staffHubRedirect('operations/library/loans', 'ops-library-loans', 'operations', 'library-loans', 'inventory', 'canManageLibrary'),
  staffHubRedirect('operations/transport', 'ops-transport', 'operations', 'transport', 'inventory', 'canManageTransport'),
  staffHubRedirect('operations/transport/drivers', 'ops-transport-drivers', 'operations', 'transport', 'inventory', 'canManageTransport', { section: 'ops-transport-drivers' }),
  staffHubRedirect('operations/transport/routes', 'ops-transport-routes', 'operations', 'transport', 'inventory', 'canManageTransport', { section: 'ops-transport-routes' }),
  staffHubRedirect('operations/assets', 'ops-assets', 'finance', 'assets', 'overview', 'canManageFinance'),
  staffHubRedirect('operations/hostels', 'ops-hostels', 'operations', 'hostels', 'inventory', 'canManageHostel'),
  staffHubRedirect('operations/front-office', 'ops-front-office', 'operations', 'front-office', 'inventory', 'canManageReception'),
  staffHubRedirect('operations/visitors', 'ops-visitors', 'operations', 'front-office', 'inventory', 'canManageReception', { section: 'ops-visitors' }),
  staffHubRedirect('operations/help-desk', 'ops-help-desk', 'operations', 'front-office', 'inventory', 'canManageReception', { section: 'ops-help-desk' }),
  staffHubRedirect('operations/health', 'ops-health', 'operations', 'health', 'inventory', 'canManageHealth'),
  ...
  staffHubRedirect('hr/leave-types', 'hr-leave-types', 'hr', 'leave-types', 'employees', 'canManageTeachers'),
  staffHubRedirect('hr/staff-attendance', 'hr-staff-attendance', 'hr', 'staff-attendance', 'employees', 'canManageTeachers'),
  staffHubRedirect('hr/employees', 'hr-employees', 'hr', 'employees', 'employees', 'canManageTeachers'),
  staffHubRedirect('hr/designations', 'hr-designations', 'hr', 'designations', 'employees', 'canManageTeachers'),
  staffHubRedirect('hr/recruitment', 'hr-recruitment-jobs', 'hr', 'recruitment', 'employees', 'canManageTeachers'),
  staffHubRedirect('hr/recruitment/applications', 'hr-recruitment-applications', 'hr', 'recruitment', 'employees', 'canManageTeachers', { section: 'hr-recruitment-applications' }),
  ...
  staffHubRedirect('people/categories', 'people-student-categories', 'people', 'student-categories', 'students', 'canManageStudents'),
  staffHubRedirect('finance/accounting', 'finance-accounting', 'finance', 'income-heads', 'overview', 'canManageFinance'),
  staffHubRedirect('finance/procurement', 'finance-procurement-hub', 'finance', 'procurement', 'overview', 'canManageFinance'),
  staffHubRedirect('finance/assets', 'finance-assets', 'finance', 'assets', 'overview', 'canManageFinance'),
  // Policies live under HR hub; keep /compliance as a friendly alias.
  staffHubRedirect('compliance', 'compliance', 'hr', 'policies', 'employees', 'canManageTeachers'),
  ...
  staffListRoute('settings/custom-fields', 'settings-custom-fields', 'settings-custom-fields', 'canManageTeachers'),
  {
    ...
    meta: { roles: ['admin', 'teacher', 'finance', 'accounts', 'examination_officer', 'receptionist', 'librarian', 'nurse', 'transport_manager', 'hostel_manager', 'parent', 'student'] },
  },
  {
    path: 'assistant',
    name: 'assistant',
  ...
  },
  {
    path: 'teachers/:id',
    name: 'teacher-detail',
    component: () => import('@/modules/teachers/views/TeacherDetailView.vue'),
    meta: { capability: 'canManageTeachers' },
  },
  {
    path: 'guardians/:id',
    name: 'guardian-detail',
    component: () => import('@/modules/guardians/views/GuardianDetailView.vue'),
    meta: { capability: 'canManageTeachers' },
  },
  {
    path: 'hr/employees/:id',
    name: 'employee-detail',
    component: () => import('@/modules/hr/views/EmployeeDetailView.vue'),
    meta: { capability: 'canManageTeachers' },
  },
  {
    path: 'operations/library/members/:id',
    name: 'library-member-detail',
    component: () => import('@/modules/operations/views/LibraryMemberDetailView.vue'),
    meta: { capability: 'canManageLibrary' },
  },
]
