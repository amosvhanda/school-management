...
import ListPage from '@/modules/shared/ListPage.vue'
...
const props = defineProps<{
  listKey: string
  /** When embedded in a hub, parent controls ?create=1 handling. */
  autoCreate?: boolean
}>()
...
<template>
  ...
  <ListPage
    ...
    :list-key="listKey"
  />
  <p v-else class="text-sm text-destructive">This section is not configured.</p>
</template>
