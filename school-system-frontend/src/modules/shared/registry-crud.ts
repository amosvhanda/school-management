...
export const moduleCrudRegistry: Record<string, ModuleCrudConfig> = {
  ...
  'academics-houses': crud(
    [
      ...
      { name: 'color', label: 'Colour', type: 'text', section: 'House', colSpan: 1 },
      {
        ...
        section: 'House',
        colSpan: 1,
        relation: { endpoint: moduleEndpoints.teachers, createRoute: '/people?tab=teachers&create=1' },
      },
  ...
  'ops-help-desk': crud(
    formSection('Support ticket', [
      { name: 'subject', label: 'Subject', type: 'text', required: true, colSpan: 2, placeholder: 'Brief summary of the issue' },
      { name: 'description', label: 'Description', type: 'textarea', colSpan: 2, placeholder: 'Details, steps to reproduce, or context' },
      {
        name: 'category',
        label: 'Category',
        type: 'select',
      ...
      { name: 'requester_phone', label: 'Requester phone', type: 'phone' },
      { name: 'requester_email', label: 'Requester email', type: 'email' },
      {
        name: 'student_id',
        label: 'Related student',
        type: 'relation',
        placeholder: 'Optional — if about a student',
        relation: studentRelation(),
      },
      {
        name: 'assigned_to',
    ...
    z.object({
      ...
      description: z.string().optional(),
      category: z.enum(['general', 'it', 'facilities', 'finance', 'academic', 'transport', 'other']).optional(),
  ...
  'hr-recruitment-jobs': crud(
    formSection('Job posting', [
      { name: 'title', label: 'Job title', type: 'text', required: true, colSpan: 2 },
      { name: 'department', label: 'Department', type: 'text', placeholder: 'Science, Admin, Finance…' },
      {
      ...
      { name: 'location', label: 'Location', type: 'text', placeholder: 'Campus or remote' },
      { name: 'openings', label: 'Openings', type: 'number', placeholder: '1' },
      { name: 'closes_at', label: 'Closes on', type: 'date' },
      {
        name: 'status',
        label: 'Status',
        type: 'select',
      ...
      { name: 'description', label: 'Role description', type: 'textarea', colSpan: 2 },
      { name: 'requirements', label: 'Requirements', type: 'textarea', colSpan: 2 },
    ]),
    z.object({
  ...
  'hr-recruitment-applications': crud(
    formSection('Application', [
      {
        ...
        required: true,
        colSpan: 2,
        relation: jobPostingRelation(),
      },
      { name: 'applicant_name', label: 'Applicant name', type: 'text', required: true },
      { name: 'email', label: 'Email', type: 'email' },
      { name: 'phone', label: 'Phone', type: 'phone' },
      { name: 'resume_url', label: 'Resume URL', type: 'text', placeholder: 'Optional link to CV', colSpan: 2 },
      { name: 'cover_letter', label: 'Cover letter', type: 'textarea', colSpan: 2 },
      { name: 'notes', label: 'Internal notes', type: 'textarea', colSpan: 2 },
      {
        name: 'status',
        label: 'Status',
        type: 'select',
    ...
    z.object({
      job_posting_id: z.string().min(1, 'Select a job posting'),
      ...
      notes: z.string().optional(),
      status: z.enum(['submitted', 'screening', 'interview', 'offered', 'hired', 'rejected']).optional(),
    }),
    { canEdit: true, canDelete: false },
  ),
  ...
  'academics-exam-schedules': crud(
    formSection('Schedule', [
      ...
      },
      {
        ...
        label: 'Room',
        type: 'relation',
        relation: roomRelation({ moduleLabel: 'room' }),
      },
      {
        name: 'starts_at',
        label: 'Starts at',
  ...
  'ops-library-loans': crud(
    formSection('Loan', [
      ...
      },
      {
        ...
        relation: libraryMemberRelation({
